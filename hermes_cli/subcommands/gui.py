...
def build_desktop_web_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser.add_argument(
        "--no-open",
        action="store_true",
        help="Do not request external-browser opening by the web runtime",
    )
    gui_parser.add_argument(
        "--source",
        action="store_true",
    ...
    gui_parser.set_defaults(func=cmd_gui, desktop_web=True)
